...
Value Eval::evaluate(const Position& pos, int* complexity, int depth) {
  ...
  bool useClassical = !useNNUE || (depth > 6 && 15 > depth && (pos.count<ALL_PIECES>() > 7 && abs(psq) > 1777));
  ...
  {
      int nnueComplexity;
      int scale = 969 + 4862 * pos.count<PAWN>() / 1024 + 58 * pos.non_pawn_material() / 4096 - 140 * depth / 1024;
      ...
      nnueComplexity = (  415 * nnueComplexity
