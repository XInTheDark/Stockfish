...
Value Eval::evaluate(const Position& pos) {
  ...
  int nnueThreshold = 1958 + 52 * (pos.count<ALL_PIECES>() - pos.count<PAWN>());
  ...
  {
      int nnueComplexity;
      int scale = 1066 + 65 * pos.non_pawn_material() / 4096;
      ...
      nnueComplexity = (  353 * nnueComplexity
                        + (426 + optimism) * abs(psq - nnue)
                        ) / 1024;
