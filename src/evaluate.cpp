...
Value Eval::evaluate(const Position& pos, int* complexity) {
  ...
  // PSQ advantage is decisive. We also use Classical eval
  // for endgames with 6 or fewer pieces. (~4 Elo at STC, 1 Elo at LTC)
  bool useClassical = !useNNUE || abs(psq) > 2048 || pos.count<ALL_PIECES>() <= 6;
