...
Value Eval::evaluate(const Position& pos) {
  ...
  else
  {
      ...
      optimism += (int) optimism * (nnueComplexity + abs(simpleEval - nnue)) * (long long) 4203 / 2097152;
      nnue     -= (int) nnue     * (nnueComplexity + abs(simpleEval - nnue)) * (long long) 61 / 2097152;

      int npm = pos.non_pawn_material() * 61 / 4096;
      v = (  nnue     * (1143 + npm + 163 * pos.count<PAWN>() / 16)
           + optimism * (155 + npm +     pos.count<PAWN>())) / 1024;
  }
