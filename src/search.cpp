...
int a1=154, a2=1449, a3=937, a4=941, a5=341, a6=470, a7=1710,
    b1=19470,
    c1=10, c2=16502, c3=102, c4=147,
    d1=69, d2=13, d3=60, d4=8, d5=1570, d6=650, d7=1400, d8=2080, d9=1000, d10=1800, d11=500,
    e1=1920, e2=156, e3=426, e4=256, e5=9, e6=280, e7=25128, e8=18755, e9=20, e10=100, e11=253,
    f1=172, f2=6, f3=4, f4=186, f5=54, f6=4, f7=3, f8=7, f9=391, f10=3,
    g1=6, g2=182, g3=230, g4=1000, g5=206, g6=5, g7=4405, g8=7278, g9=13, g10=103, g11=138, g12=24, g13=16,
    h1=4, h2=21, h3=3,
    // Singular beta
    i1=96, i2=64,
    i3=25, i4=10, i5=13, i6=10, i7=88, i8=5705,
    j1_=7, j2=12, j3=3, j4=3, j5=4082, j6=11079, j7=4626, j8=6, j9=19,
    k1=68, k2=12, k3=588, k4=5, k5=4,
    l1=12535, l2=12535,
    m1=5, m2=97, m3=10,
    n1=168, n2=110, n3=153;

TUNE(a1, a2, a3, a4, a5, a6, a7, b1, c1);
TUNE(SetRange(1, 33004), c2);
TUNE(c3, c4, d1, d2, d3, d4, d5, d6, d7, d8, d9, d10, d11, e1, e2, e3, e4, e5);
TUNE(SetRange(1, 560), e6);
TUNE(e7, e8, e9, e10, e11);
TUNE(SetRange(1, 344), f1);
TUNE(f2, f3, f4, f5, f6, f7, f8, f9, f10, g1, g2, g3, g4, g5, g6, g7);
TUNE(SetRange(1, 14556), g8);
TUNE(g9, g10, g11, g12, g13, h1, h2, h3, i1, i2, i3, i4, i5, i6, i7, i8);
TUNE(j1_, j2, j3, j4, j5, j6, j7, j8, j9, k1, k2, k3, k4, k5, l1, l2, m1, m2, m3, n1, n2, n3);
         ...
         && !(Limits.depth && mainThread && rootDepth > Limits.depth))
  {
          ...
          && !mainThread->stopOnPonderhit)
      {
          double fallingEval = (d1 + d2 * (mainThread->bestPreviousAverageScore - bestValue)
                                    +  d3 * (mainThread->iterValue[iterIdx] - bestValue)) / 6196.0;
          fallingEval = std::clamp(fallingEval, 0.5, 1.5);

          // If the bestMove is stable over several iterations, reduce time accordingly
          timeReduction = lastBestMoveDepth + d4 < completedDepth ? d5 / 1000.0 : d6 / 1000.0;
          double reduction = (d7 / 1000.0 + mainThread->previousTimeReduction) / (d8 / 1000.0 * timeReduction);
          double bestMoveInstability = d9 / 1000.0 + d10 / 1000.0 * totBestMoveChanges / Threads.size();
          ...
          if (Time.elapsed() > totalTime)
          {
              ...
              if (mainThread->ponder)
                  ...
                  Threads.stop = true;
                   ...
                   && Time.elapsed() > totalTime * d1 / 1000.0)
...
namespace {
  ...
  Value search(Position& pos, Stack* ss, Value alpha, Value beta, Depth depth, bool cutNode) {
    ...
    {
        int bonus = std::clamp(-19 * int((ss-1)->staticEval + ss->staticEval), -e1, e1);
    ...
    if (   !PvNode
        ...
        &&  eval >= beta
        &&  eval >= ss->staticEval
        &&  ss->staticEval >= beta - e9 * depth - improvement * e10 / 1300 + e11
        && !excludedMove
...
moves_loop: // When in check, search starts here
              ...
              || givesCheck)
          {
              ...
              if (   !givesCheck
                  ...
                  && ss->staticEval + g2 + g3 * lmrDepth + PieceValue[EG][pos.piece_on(to_sq(move))]
                   + captureHistory[movedPiece][to_sq(move)][type_of(pos.piece_on(to_sq(move)))] * g4 / 7000 < alpha)
                  continue;
      ...
      if (ss->ply < thisThread->rootDepth * 2)
      {
          ...
          if (   !rootNode
           ...
           /* &&  ttValue != VALUE_NONE Already implicit in the next condition */
              ...
              &&  tte->depth() >= depth - h3)
          {
              Value singularBeta = ttValue - (i1 + i2 * (ss->ttPv && !PvNode)) * depth / 64;
              ...
              if (value < singularBeta)
              {
                  ...
                  if (  !PvNode
                      && value < singularBeta - i3
                      && ss->doubleExtensions <= i4)
                  {
                      extension = 2;
                      depth += depth < i5;
                  }
  ...
  void update_all_stats(const Position& pos, Stack* ss, Move bestMove, Value bestValue, Value beta, Square prevSq,
    ...
    {
        int bonus2 = bestValue > beta + n3 ? bonus1               // larger bonus
