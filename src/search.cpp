...
int a0=133, a1=42, a2=1444, a3=977, a4=839, a5=322, a6=505, a7=1504,
    b1=20620,
    c1=10, c2=17307, c3=116, c4=122,
    e0=19, e1=1876, e3=548, e4=247, e5=9, e6=312, e7=26265, e8=17379, e9=22, e11=267,
    f1=146, f2=6, f3=5, f4=165, f5=70, f6=3, f8=7, f9=385, f10=4,
    g1=7, g2=194, g3=200, g5=214, g6=6, g7=3580, g8=6735, g9=14, g10=116, g11=143, g12=29,
    h1=4, h2=24, h3=2, h4=3,
    sb1=67, sb2=59, sb3=20, sb4=12, sb5=14,
    i2=16, i3=3, i4=1, i6=9, i8=4555, i10=3, i11=2,
    j1_=7, j4=3, j5=4137, j6=10654, j7=4287, j8=5, j9=23,
    k1=61, k2=10, k3=747, k4=6, k5=3,
    l1=13752, l2=12875, l3=2, l4=11,
    m1=6, m2=723, m3=11,
    n1=203, n4=98, n5=152;
...
TUNE(g9, g10, g11, g12, h1, h2, h3, h4, sb1, sb2, sb3, sb4, sb5, i2, i3, i4, i6, i8, i10, i11);
TUNE(j1_, j4, j5, j6, j7, j8, j9, k1, k2, k3, k4, k5, l1, l2, l3, l4, m1, m2, m3, n1);
TUNE(n4, n5);
...
namespace {
  ...
  Depth reduction(bool i, Depth d, int mn, Value delta, Value rootDelta) {
    ...
    return  (reductionScale + a2 - int(delta) * a3 / int(rootDelta)) / 1024
          + (!i && reductionScale > a4);
  }
...
namespace {
  ...
  Value search(Position& pos, Stack* ss, Value alpha, Value beta, Depth depth, bool cutNode) {
    ...
    if (   !ss->ttPv
        &&  depth < e5
        &&  eval - futility_margin(depth, cutNode && !ss->ttHit, improving) - (ss-1)->statScore / e6 >= beta
        &&  eval >= beta
        &&  eval < e7) // smaller than TB wins
        return eval;
...
moves_loop: // When in check, search starts here
    ...
    while ((move = mp.next_move(moveCountPruning)) != MOVE_NONE)
    {
          ...
          && bestValue > VALUE_TB_LOSS_IN_MAX_PLY)
      {
              ...
              || givesCheck)
          {
              ...
              if (   !givesCheck
                  && lmrDepth < g1
                  && !ss->inCheck
                  && ss->staticEval + g2 + g3 * lmrDepth + PieceValue[pos.piece_on(to_sq(move))]
                   + captureHistory[movedPiece][to_sq(move)][type_of(pos.piece_on(to_sq(move)))] / 7 < alpha)
                  continue;

              // SEE based pruning for captures and checks (~11 Elo)
              if (!pos.see_ge(move, Value(-g5) * depth))
                  continue;
          }
          else
          {
              ...
              if (!pos.see_ge(move, Value(-g12 * lmrDepth * lmrDepth)))
                  continue;
          }
      }
      ...
      if (ss->ply < thisThread->rootDepth * 2)
      {
          ...
          if (   !rootNode
              &&  depth >= h1 - (thisThread->completedDepth > h2) + h3 * (PvNode && tte->is_pv())
              &&  move == ttMove
      ...
      if (   ss->ttPv
          && !likelyFailLow)
          r -= cutNode && tte->depth() >= depth ? i10 : i11;
    ...
    */
    ...
    {
        int bonus = (depth > m1) + (PvNode || cutNode) + (bestValue < alpha - m2) + ((ss-1)->moveCount > m3);
  ...
  Value qsearch(Position& pos, Stack* ss, Value alpha, Value beta, Depth depth) {
    ...
    else
    {
        ...
        futilityBase = std::min(ss->staticEval, bestValue) + n1;
    }
  ...
  void update_all_stats(const Position& pos, Stack* ss, Move bestMove, Value bestValue, Value beta, Square prevSq,
    ...
    {
        int bestMoveBonus = bestValue > beta + n5 ? quietMoveBonus  // larger bonus
