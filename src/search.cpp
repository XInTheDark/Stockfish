...
int a1=117, a2=44, a3=12475, a4=246, a5=351, a6=1136, a7=519, a8=306, a9=1258,

b1=9, b2=12487, b3=134, b4=97, b5=71, b6=18790,

c1=14, c2=1723, c3=1455, c4=438, c5=332, c6=154, c7=11, c8=314, c9=16620, c10=21, c11=330, c12=154, c13=6, c14=4,

d1=8, d2=181, d3=68, d4=452, d5=7, d6=277, d7=292, d8=197,

e1=6, e2=4211, e3=6437, e4=15, e5=57, e6=144, e7=57, e8=121, e9=26,

f1=30, f2=60, f3=54, f4=16, f5=78, f6=16, f7=4394, f8=4392, f9=14189,

g1=49, g2=2, g3=13, g4=13652, g5=12761, g6=5, g7=15736, g8=11,

h1=206, h2=74, h3=1118, h4=793, h5=863, h6=166;

TUNE(a1, a2, a4, a5, a6, a7, a8, a9,
     b1, b3, b4, b5, b6,
     c1, c2, c3, c4, c5, c6, c7, c9, c10, c11, c13, c14,
...
void Search::Worker::clear() {
    ...
    for (size_t i = 1; i < reductions.size(); ++i)
        reductions[i] = int((b6 / 1000.0 + std::log(size_t(options["Threads"])) / 2) * std::log(i));
}
...
Value Search::Worker::search(
  Position& pos, Stack* ss, Value alpha, Value beta, Depth depth, bool cutNode) {
    ...
    if (!PvNode && (ss - 1)->currentMove != Move::null() && (ss - 1)->statScore < c9
        && eval >= beta && eval >= ss->staticEval && ss->staticEval >= beta - c10 * depth + c11
        ...
        && beta > VALUE_TB_LOSS_IN_MAX_PLY)
    {
        ...
        Depth R = std::min(int(eval - beta) / c12, c13) + depth / 3 + c14;
...
moves_loop:  // When in check, search starts here
    ...
    while ((move = mp.next_move(moveCountPruning)) != Move::none())
    {
        ...
        if (!rootNode && pos.non_pawn_material(us) && bestValue > VALUE_TB_LOSS_IN_MAX_PLY)
        {
            ...
            else
            {
                ...
                if (!ss->inCheck && lmrDepth < e4
                    && ss->staticEval + (bestValue < ss->staticEval - e5 ? e6 : e7)
                           + e8 * lmrDepth
                         <= alpha)
                    continue;
        ...
        ss->statScore = 2 * thisThread->mainHistory[us][move.from_to()]
                      + (*contHist[0])[movedPiece][move.to_sq()]
                      + (*contHist[1])[movedPiece][move.to_sq()]
                      + (*contHist[3])[movedPiece][move.to_sq()] - f8;
        ...
        if (depth >= 2 && moveCount > 1 + rootNode)
        {
            ...
            if (value > alpha && d < newDepth)
            {
                ...
                const bool doDeeperSearch    = value > (bestValue + g1 + 2 * newDepth);  // (~1 Elo)
        ...
        if (value > bestValue)
        {
            ...
            if (value > alpha)
            {
                ...
                else
                {
                    ...
                    if (depth > g2 && depth < g3 && beta < g4 && value > -g5)
                        depth -= 2;
    ...
    {
        int bonus = (depth > g6) + (PvNode || cutNode) + ((ss - 1)->statScore < -g7)
                  + ((ss - 1)->moveCount > g8);
        update_continuation_histories(ss - 1, pos.piece_on(prevSq), prevSq,
