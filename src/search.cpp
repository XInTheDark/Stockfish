...
namespace Stockfish {
int a1=119, a2=44, a3=53, a4=297, a5=48, a6=9912, a7=232, a8=325, a9=1276, a10=570, a11=279, a12=1289,

    b1=10, b2=11623, b3=128, b4=92, b5=67, b6=2164,

    c1=14, c2=1673, c3=1321, c4=477, c5=282, c6=140, c7=11, c8=275, c9=17072, c10=21, c11=310, c12=148,

    d1=172, d2=64, d3=413, d4=700, d5=301, d6=297, d7=200,

    e1=600, e2=4184, e3=5205, e4=15, e5=57, e6=139, e7=54, e8=125, e9=25,

    f0=31, f1=58, f2=59, f3=14, f4=38, f5=3999, f6=4811, f7=13637,

    g1=46, g2=12, g3=14651, g4=12740, g5=15086, g6=11, g7=143,

    h1=235, h2=81, h3=1135, h4=756, h5=1018, h6=170,
...
int stat_bonus(Depth d) { return std::clamp(a7 * d - a8, 0, a9); }
...
moves_loop:  // When in check, search starts here
    ...
    while ((move = mp.next_move(moveCountPruning)) != Move::none())
    {
        ...
        if (!rootNode && pos.non_pawn_material(us) && bestValue > VALUE_TB_LOSS_IN_MAX_PLY)
        {
            ...
            if (capture || givesCheck)
            {
                ...
                if (!givesCheck && lmrDepth < std::round(d4 / 100.0) && !ss->inCheck)
                {
                    Piece capturedPiece = pos.piece_on(move.to_sq());
                    int   futilityEval =
                      ss->staticEval + d5 + d6 * lmrDepth + PieceValue[capturedPiece]
            ...
            else
            {
                ...
                if (lmrDepth < std::round(e1 / 100.0) && history < -e2 * depth)
                    continue;
                ...
                Value futilityValue =
                  ss->staticEval + (bestValue < ss->staticEval - e5 ? e6 : e7) + e8 * lmrDepth;

                // Futility pruning: parent node (~13 Elo)
                if (!ss->inCheck && lmrDepth < e4 && futilityValue <= alpha)
                {
        ...
        ss->statScore = 2 * thisThread->mainHistory[us][move.from_to()]
                      + (*contHist[0])[movedPiece][move.to_sq()]
                      + (*contHist[1])[movedPiece][move.to_sq()]
                      + (*contHist[3])[movedPiece][move.to_sq()] - f6;
        ...
        if (value > bestValue)
        {
            ...
            if (value > alpha)
            {
                ...
                else
                {
                    ...
                    if (depth > 2 && depth < g2 && beta < g3 && value > -g4)
                        depth -= 2;
    ...
    {
        int bonus = (depth > 5) + (PvNode || cutNode) + ((ss - 1)->statScore < -g5)
                  + ((ss - 1)->moveCount > g6)
                  + (!ss->inCheck && bestValue <= ss->staticEval - g7);
        update_continuation_histories(ss - 1, pos.piece_on(prevSq), prevSq,
