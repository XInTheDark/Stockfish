    ...
    while ((move = mp.next_move(moveCountPruning)) != MOVE_NONE)
    {
          ...
          && bestValue > VALUE_TB_LOSS_IN_MAX_PLY)
      {
              ...
              || givesCheck)
          {
              ...
              if (   !givesCheck
                  && lmrDepth < 6
                  && !ss->inCheck
                  && ss->staticEval + 203 + 224 * lmrDepth + PieceValue[EG][pos.piece_on(to_sq(move))]
                   + captureHistory[movedPiece][to_sq(move)][type_of(pos.piece_on(to_sq(move)))] * 1052 / 7000 < alpha)
                  continue;
          ...
          else
          {
              ...
              if (   !ss->inCheck
                  && lmrDepth < 12
                  && ss->staticEval + 96 + 147 * lmrDepth <= alpha)
                  continue;
      ...
      if (ss->ply < thisThread->rootDepth * 2)
      {
          ...
          // Quiet ttMove extensions (~1 Elo)
                   ...
                   && move == ttMove
                   && move == ss->killers[0]
                   && (*contHist[0])[movedPiece][to_sq(move)] >= 6101)
              extension = 1;
      }
      ...
      r -= ss->statScore / (10088 + 5227 * (depth > 6 && depth < 20));
              ...
              || (cutNode && (ss-1)->moveCount > 1)))
      {
          ...
          if (value > alpha && d < newDepth)
          {
              ...
              const bool doDeeperSearch = value > (alpha + 57 + 12 * (newDepth - d));
              const bool doEvenDeeperSearch = value > alpha + 665 && ss->doubleExtensions <= 5;
